...
export const cognitoAuthConfig: AuthProviderProps = {
  ...
  redirect_uri: typeof window !== 'undefined' ? (window.location.origin.endsWith('/') ? window.location.origin : `${window.location.origin}/`) : 'https://soluciones-cloud-v1.vercel.app/',
  response_type: 'code',
